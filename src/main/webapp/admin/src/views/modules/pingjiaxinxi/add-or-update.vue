          ...
          <el-form-item class="input" label="评分" prop="pingfen">
              <el-input v-model="ruleForm.pingfen" 
                placeholder="评分" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教学评论" prop="jiaoxuepinglun">
          <el-input v-model="ruleForm.jiaoxuepinglun" 
              placeholder="教学评论" clearable  :readonly="ro.jiaoxuepinglun"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教学评论" prop="jiaoxuepinglun">
              <el-input v-model="ruleForm.jiaoxuepinglun" 
                placeholder="教学评论" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.pingfen = true;
            continue;
	            	            ...
	            	            if(o=='jiaoxuepinglun'){
            this.ruleForm.jiaoxuepinglun = obj[o];
	    this.ro.jiaoxuepinglun = true;
            continue;
          }
	            	            if(o=='riqi'){
