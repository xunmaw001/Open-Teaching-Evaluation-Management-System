          ...
          <el-form-item class="input" label="教师姓名" prop="jiaoshixingming">
              <el-input v-model="ruleForm.jiaoshixingming" 
                placeholder="教师姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="课程次数" prop="kechengcishu">
          <el-input v-model="ruleForm.kechengcishu" 
              placeholder="课程次数" clearable  :readonly="ro.kechengcishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="课程次数" prop="kechengcishu">
              <el-input v-model="ruleForm.kechengcishu" 
                placeholder="课程次数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="综合评分" prop="zonghepingfen">
          <el-input v-model="ruleForm.zonghepingfen" 
              placeholder="综合评分" clearable  :readonly="ro.zonghepingfen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="综合评分" prop="zonghepingfen">
              <el-input v-model="ruleForm.zonghepingfen" 
                placeholder="综合评分" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="总体评价" prop="zongtipingjia">
          <el-input v-model="ruleForm.zongtipingjia" 
              placeholder="总体评价" clearable  :readonly="ro.zongtipingjia"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaoshixingming = true;
            continue;
	            	            ...
	            	            if(o=='kechengcishu'){
            this.ruleForm.kechengcishu = obj[o];
	    this.ro.kechengcishu = true;
            continue;
          }
	            	            if(o=='zonghepingfen'){
	...
	this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../ssmonwk4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zonghepingjia/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zonghepingjiaCrossAddOrUpdateFlag = false;
                  this.parent.search();
