  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.22);borderRadius:10px">
        <h1 class="h1" style="color:rgba(104, 223, 240, 1);fontSize:28px;">开放式教学评价管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.xingming" autocomplete="off" placeholder="姓名" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.jiaoling" class="input" type="text" placeholder="教龄">
			   </div>
			 </div> -->
			<el-form-item label="教龄" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.jiaoling" autocomplete="off" placeholder="教龄" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">类型</div>
			   <div class="input-container">
			     <input v-model="ruleForm.leixing" class="input" type="text" placeholder="类型">
			   </div>
			 </div> -->
			<el-form-item label="类型" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.leixing" autocomplete="off" placeholder="类型" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                                                                                                                                    ...
                                                                                                                                                                                    if(`jiaoshi` == this.tableName && this.ruleForm.jiaoling&&(!this.$validate.isIntNumer(this.ruleForm.jiaoling))){
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210118/7a13608dd7524fccb11bd14591267ee5.jpg");
		height: 100vh;
