          ...
          <el-select v-model="ruleForm.xingbie" placeholder="请选择性别">
            <el-option
                ...
                :value="item">
                        ...
                        <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="教龄" prop="jiaoling">
          <el-input v-model="ruleForm.jiaoling"               placeholder="教龄" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="类型" prop="leixing">
          <el-input v-model="ruleForm.leixing"               placeholder="类型" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
...
export default {
  ...
  methods: {
        ...
        return
                                                                                                                                                                                    ...
                                                                                                                                                                                    if( 'jiaoshi' ==this.flag && this.ruleForm.jiaoling&&(!isIntNumer(this.ruleForm.jiaoling))){
